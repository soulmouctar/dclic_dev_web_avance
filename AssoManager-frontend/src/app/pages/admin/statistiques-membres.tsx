  ...
  const loadStatistics = async () => {
    ...
    try {
      ...
      if (trendsData.length === 0) {
        trendsData = [
          { month: 'Jan', year: filters.year, member_count: 0, total_amount: 0 },
          { month: 'Fév', year: filters.year, member_count: 0, total_amount: 0 },
          { month: 'Mar', year: filters.year, member_count: 0, total_amount: 0 },
          { month: 'Avr', year: filters.year, member_count: 0, total_amount: 0 },
          { month: 'Mai', year: filters.year, member_count: 0, total_amount: 0 },
          { month: 'Juin', year: filters.year, member_count: 0, total_amount: 0 }
        ];
      }
